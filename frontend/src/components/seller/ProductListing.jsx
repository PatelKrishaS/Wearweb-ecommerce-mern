        ...
        <div className="col-md-10">
          <div className="card card-primary card-outline mb-4">
            <div className="card-header">
              <div className="card-title" >Product Listing Form</div>
            </div>
              ...
              <div className="card-body">
                ...
                <div className="mb-3">
                  ...
                  <small className="form-text text-muted">
                    Separate tags with commas (e.g., electronics, summer, casual)
                  </small>
                  {errors.tags && (
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    {...register('stockQuantity', {
                      ...
                      max: {
                        value: 100000,
                        message: 'Stock Quantity cannot exceed 100,000*',
                      },
                    })}
                  />
                ...
                <div className="mb-3">
                  ...
                  />
                  {errors.warranty && (
                    <div className="invalid-feedback">{errors.warranty.message}</div>
                  )}
                </div>
                ...
                <div className="mb-3">
                  ...
                  />
                  {errors.shippingCost && (
                    <div className="invalid-feedback">{errors.shippingCost.message}</div>
                  )}
                </div>
                ...
                <div className="mb-3">
                  ...
                  />
                  {errors.returnPolicy && (
                    <div className="invalid-feedback">{errors.returnPolicy.message}</div>
                  )}
                </div>
